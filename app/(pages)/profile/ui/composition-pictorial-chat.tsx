...
const SERIES_COLORS = {
  light: [
    "#adb5bd", // Other
    "#ffd43b", // Essential Fat
    "#ffa94d", // Non-Essential Fat
    "#40c057", // Muscle Tissue
    "#228be6", // Bone
  ],
  dark: [
    "#868e96", // Other (darker gray)
    "#ffd43b", // Essential Fat (brighter yellow)
    "#ffa94d", // Non-Essential Fat
    "#69db7c", // Muscle Tissue (lighter green)
    "#4dabf7", // Bone (lighter blue)
  ],
};
...
const PATHS = [
  ...
  {
    definition:
      "m 656.59433,740.097 c -0.634,-1.435 -13.566," +
  ...
  {
    definition:
      "m 288.24306,919.66652 c -2.887,-37.612 3.116," +
...
const CompositionPictorialChart = () => {
  const theme = useChartTheme();
  const colorScheme = theme.title.style.color === "#C1C2C5" ? "dark" : "light";
  const seriesColors = SERIES_COLORS[colorScheme];
  ...
  const options: Highcharts.Options = {
    ...
    accessibility: {
      ...
      point: { valueDescriptionFormat: "{value}." },
      series: { descriptionFormat: "" },
    ...
    tooltip: {
      ...
      pointFormat:
        ...
        '<span style="font-size: 1.2em; color: {series.color}; font-weight: bold">{point.y}%</span>',
    },
    plotOptions: {
      series: {
        // @ts-expect-error Highcharts context for pictorial
        type: "pictorial",
        pointPadding: 0,
        groupPadding: 0,
        dataLabels: {
...
export default CompositionPictorialChart;
