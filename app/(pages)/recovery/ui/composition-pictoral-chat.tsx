...
const options: Highcharts.Options = {
  ...
  series: [
    // @ts-expect-error Highcharts context for pictorial
    { name: "Other", data: [25, 25], type: "pictorial" },
    // @ts-expect-error Highcharts context for pictorial
    { name: "Essential Fat", data: [12, 3], type: "pictorial" },
    // @ts-expect-error Highcharts context for pictorial
    { name: "Non-Essential Fat", data: [15, 12], type: "pictorial" },
    // @ts-expect-error Highcharts context for pictorial
    { name: "Muscle Tissue", data: [36, 45], type: "pictorial" },
    // @ts-expect-error Highcharts context for pictorial
    { name: "Bone", data: [12, 15], type: "pictorial" },
  ],
